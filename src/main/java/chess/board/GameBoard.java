...
public class GameBoard implements Board{
    ...
    private volatile static GameBoard uniqueInstance;
    ...
    public final boolean isVirtualBoard = false; ///---> I need this for the moment to allow my minimax algo to undo the pawn moves
    ...
    private GameBoard() {
        ...
        this.whiteOccupancyBitboard = new Bitboard(0x000000000000FFFFL, false);
        this.blackOccupancyBitboard = new Bitboard(0xFFFF000000000000L, true);
...
//              0      1     2     3    4     5     6    7
        ...
        this.blackKing = new Bitboard(0x0800000000000000L,true);
